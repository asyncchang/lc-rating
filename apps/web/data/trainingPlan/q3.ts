...
export const trainingPlanRhythm: TrainingPlanRhythmRow[] = [
  ...
  },
  {
    when: "週六（雙週）",
    minutes: "90 分",
    what: "限時模擬舊週賽 Q1–Q3，從競賽頁挑分數帶相近的場次。非模擬週改做 45 分鐘超載題（規則見下）",
  },
  {
    when: "週日",
    minutes: "40 分",
